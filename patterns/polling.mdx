...
If you depend on a 3rd-party API that processes data (like video encoding or AI generation) but *doesn't* offer webhooks, you usually have to run a cron job to poll for status.
