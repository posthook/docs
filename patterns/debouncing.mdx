...
When events happen in rapid succession (e.g., a user saving a document multiple times), you often only want to perform a reaction (like sinking to an external API) once the activity stops.
