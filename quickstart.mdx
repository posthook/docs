...
This guide will show you how to set up Posthook, connect your local environment, and send your first Scheduled Hook.
...
Use the CLI to connect your local development server to Posthook. This allows you to receive webhooks locally without setting up tunneling tools like ngrok.
...
In a new terminal window, schedule a test webhook to be sent immediately.
...
```
2024-01-01 12:00:00 [200 OK] POST /api/webhooks
```
