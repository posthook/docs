...
To protect against replay attacks, where an attacker intercepts and resends a valid payload, verify the `postedAt` timestamp in the request body.

This field contains the ISO 8601 timestamp of when Posthook sent the request.
